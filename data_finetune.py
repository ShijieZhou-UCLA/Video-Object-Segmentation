...
class load_data_finetune:
    def __init__(self, train_list, test_list, database_root, store_memory=True, data_aug=False):
        """ Load data for test (finetune) network
        train_list: list with the paths of the images to use for training
        test_list: list with the paths of the images to use for testing (Images must be between 0 and 255)
